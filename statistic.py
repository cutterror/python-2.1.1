...
class Statistic:
    def __init__(self, selected_vacancy: str):
        ...
        self.__salary_dynamics = dict()
        self.__num_vacancies_dynamics = dict()
        self.__selected_salary_dynamics = dict()
        self.__selected_num_vacancies_dynamics = dict()
        self.__city_salary_dynamics = dict()
        self.__city_num_vacancies_dynamics = dict()
